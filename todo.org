...
- [ ] create something like 'migrate init' to initialize a new project
...
- [ ] when migrations caused errors, then when migrate is run again it should
      stop immediately.
- [ ] when migrations caused errors, there should be a command to mark them as
      fixed, from where we can continue running migrate
